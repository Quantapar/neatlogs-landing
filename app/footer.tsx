...
export default function Footer2() {
  return (
    <footer className="relative overflow-hidden min-h-[500px] flex flex-col justify-between bg-[#FAFAFA]">
      ...
      <div className="relative z-10 w-full flex justify-center mt-auto translate-y-[5%]">
        <h1 className="text-[30vw] text-black font-medium leading-[0.75] tracking-tighter pointer-events-none">
          neatlogs
        </h1>
      </div>
    </footer>
