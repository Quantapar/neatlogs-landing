    ...
    <main className="relative flex min-h-screen w-full flex-col bg-[#EAF3F6]">
      <div className="relative w-full aspect-[3/2] overflow-hidden">
        ...
        <section className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center px-6 pt-[6%] sm:pt-[7%]">
          <span className="font-pixel text-[11px] uppercase tracking-[0.22em] text-zinc-700">
            For teams building AI agents
          </span>

          <h1 className="font-pixel mt-5 max-w-3xl text-center text-4xl font-medium leading-[1.1] tracking-[-0.01em] text-zinc-950 sm:text-5xl md:text-6xl lg:text-7xl">
